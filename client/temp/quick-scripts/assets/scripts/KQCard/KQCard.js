(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/KQCard/KQCard.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c548c0gMf5BGIH4309MULw+', 'KQCard', __filename);
...
var KQCard = function KQCard(point, color, index) {
    ...
    this.sort = function (otherCard) {
        ...
        var AisMax = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
KQCard.containTongHua = function (cards) {
    var minLength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
...
KQCard.sortByColor = function (card1, card2) {
    var pointAsc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
KQCard.sort = function (card1, card2) {
    ...
    var AisMax = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=KQCard.js.map
