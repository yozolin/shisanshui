...
cc._RF.push(module, '9aa4aH/Ha1JfaEeY5nFj5P1', 'CompareCards', __filename);
...
cc.Class({
    ...
    setScores: function setScores(scores) {
        var Layouts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        var is_WH = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    _creatorNodes: function _creatorNodes(nodes, name, path, paths) {
        var w_h = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    ...
    _loadCardFrame: function _loadCardFrame(cardName, callback) {
        var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "play/CardTypeCombine/pockList";
        var paths = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "public-pic-card-poker-";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=CompareCards.js.map
