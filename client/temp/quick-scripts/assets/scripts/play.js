...
cc._RF.push(module, '16c65H2Pw9PBaQSvw69LGLQ', 'play', __filename);
// scripts/play.js
...
var Play = cc.Class({
    ...
    updateGameStatus: function updateGameStatus() {
        var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : GAMESTATUS.WAIT_PEOPLE;
    ...
    _showTotalGameResult: function _showTotalGameResult() {
        var showDelay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2;
    ...
    _showCompareCardStep: function _showCompareCardStep() {
        ...
        var isContainExtra = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    showNetworkMessage: function showNetworkMessage() {
        var msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "网络链接断开，重新连接中...";
    ...
    showCheckMessage: function showCheckMessage() {
        var msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '检查网络中...';
