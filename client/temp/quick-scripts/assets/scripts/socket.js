(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/socket.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cf75cLLNo1ETbJFrx/23i/H', 'socket', __filename);
// scripts/socket.js
...
var Socket = cc.Class({
  ...
  _strongVerifyData: function _strongVerifyData() {
    ...
    if (!data["userId"]) {
      if (this.userInfo && _typeof(this.userInfo) == 'object' && this.userInfo.id) {
...
Socket.sendAnswerDissolve = function (userId) {
  var answer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
