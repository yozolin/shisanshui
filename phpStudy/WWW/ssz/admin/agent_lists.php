...
# 构建查询语句
$query = "SELECT * FROM {$table_name} {$where}  ORDER BY lastLoginTime desc LIMIT {$start},{$limit}";
...
<table class="table table-striped table-bordered table-hover dataTables-example dataTable">
    ...
    <?php foreach($data as $key=>$value){ ?>
        <tr>
            ...
            <label>
            <input type="checkbox" name="check" onclick="selecPerms(this)" checked="checked"></label>
        <?php }else{  ?>
            <label>
                <input type="checkbox" name="check" onclick="selecPerms(this)" ></label>
            <?php }?>
            <input type="hidden" id="perm" value="<?php echo $value['permission']?>">
            </td>
            <?php }?>
            <td>
                ...
                <input type="hidden" name="permission" value="<?php echo $value['permission']?>" id="quanxian">
 ...
 function selecPerms(obj){
    var permission = $(obj).parent().siblings('#perm').val();
    var id =$(obj).parent().parent().siblings('#user_id').html(); 
    
    $.ajax({
        type:"post",
        url:"common_ajax.php",
        data:{agId:id,quanxian:permission},
