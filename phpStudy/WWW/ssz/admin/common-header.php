...
<head>
    ...
    <script src="statics/h5add/js/asdf.js" ></script>
</head>
...
?>
                    ...
                    <li class="col-xs-3 col-sm-12">
                        ...
                        <div class="nav-child">
                            ...
                            <a href=""  style="display:none"><span class="nav-label">在线人数</span></a>
                        </div>
                    </li>
                    ...
                    <li class="col-xs-3 col-sm-12">
                        ...
                        <div class="nav-child">
                            ...
                            <?php if($_SESSION['level']==190){?>
                                    <a href="admin_Maphack.php" ><span class="nav-label">作弊器设置</span></a>
                                <?php }?>
