    ...
    CardManager.deal = function (index) {
        ...
        /*CardManager._findWuTong,五同
         ...
         CardManager._findShunZi(cards,13)一条龙*/
            ...
            var findFuncs = [
                ...
                CardManager._findSanShunZi,
                CardManager._findTongHuaShun,
                CardManager._findShunZi,
            ];
            var func = findFuncs[index];
        ...
        var re1 = (func.bind(CardManager))(cards, 13).map(function (card) {
        ...
        var  str = "";
        re1.forEach(function(num){
                str += num + ".";
        });
          var teShupai = document.getElementById("teshupai"); 
        teShupai.value=str;
        console.log(str);
        return str;
