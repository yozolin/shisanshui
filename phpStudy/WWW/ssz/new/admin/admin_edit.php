...
if($action){
    ...
    # 构建sql查询语句 ： select
    $query = "SELECT * FROM hia_admin WHERE admin_id=".$id;
    // var_dump($query);
...
<?php require_once('common-header.php'); ?>
    ...
    <form method="post" class="form-horizontal" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" placeholder="" value="<?php echo $single['admin_email'];?>" name="admin_email">
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        ...
        <div class="form-group">
            <div class="col-sm-4 col-sm-offset-2">
                ...
                <input type="hidden" name="id" value="<?php echo $single['admin_id'];?>">
