    ...
    AudioManager: [function(e, t, n) {
        ...
        o = cc.Class({
            ...
            onLoad: function() {
                ...
                cc.game.isPersistRootNode(this.node) && cc.log("添加全局节点成功"),
            ...
            playMusic: function() {
                ...
                this.bgAudioId != -1 && (cc.log("play"), cc.audioEngine.setVolume(this.bgAudioId, this.mValue))
            },
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.socket.getWxInfo = function(t) {
             	...
             	var t = '{"openid":"oYLlV0TQgEQlics3_cEanTffEb28","nickname":"imya","sex":1,"language":"zh_CN","city":"Changsha","province":"Hunan","country":"CN","headimgurl":"http://wx.qlogo.cn/mmopen/BVyz4R8q6puJibEv1hrsaTmIKQhkaTS9FyvcevvC5hlxFnfOuspDjicG0GtzyJXOhNT7g1WZDeCDQhnRdEOgz3QMnP0F9iboQGy/0","privilege":[]}';
				/*-----------------------------------------------*/ 
                if(!cc.sys.isNative){
                ...
                //cc.sys.isNative || i.setUserInfo(t)
            },
            onDestroy: function() {
                this.socket.receviceMessage = function() {}
            },
    ...
    socket: [function(e, t, n) {
        ...
        r = cc.Class({
            ...
            _dispatchResponse: function(e) {
                ...
                n = t.action;
                n && o.emit(n, t),
                null != t.shareUrl && (cc.shareUrl = t.shareUrl, console.log(cc.shareUrl))
            },
            _registerAppActiveChange: function() {
                cc.game.on(cc.game.EVENT_HIDE, this._appEnterBackground, this),
                cc.game.on(cc.game.EVENT_SHOW, this._appBecomActive, this)
